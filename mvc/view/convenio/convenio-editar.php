...
<form id="frm-alumno" action="?c=Convenio&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="NombreConvenio" value="<?php echo $alm->NombreConvenio ?>" class="form-control" placeholder="Nombre de Convenio" required="required"/>
    </div>
    
    <div class="form-group">
        <label>Valor Total del convenio</label>
        <input type="text" name="Valor" value="<?php echo $alm->Valor ?>" class="form-control" placeholder="Numero de identificación" required="required"/>
    </div>
    
    <div class="form-group">
        <label>Nombre del cliente</label>
      <select name="NombreCliente" id="select" class="form-control">
     <option required value="">Seleccione el cliente</option>
        <?php
do {  
?>
