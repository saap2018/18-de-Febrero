...
$query_Recordset1 = "SELECT Nombre, Apellidos FROM empleados";
...
?>
        ...
        Nombre del empleado 
          ...
          <select name="NombreEmpleado" id="select5">
            <?php
do {  
?>
            <option value="<?php echo $row_Recordset1['Nombre']." ".$row_Recordset1['Apellidos']?>"><?php echo $row_Recordset1['Nombre']?></option>
            <?php
